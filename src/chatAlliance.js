...
const allianceChat = () => {
    ...
    const init = () => {
        ...
        $('.sideRight').before('<div id="allianceMessages"></div>').remove();
        msgDiv = $("#allianceMessages").attr('class', 'sideRight');
...
export default checkInit([], ['/chatalliance', '/chatgeneral'], allianceChat);