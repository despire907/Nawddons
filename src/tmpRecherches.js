...
const tmpRecherches = () => {
    ...
    function tmp() {
        ...
        while (i < 16) {
            ...
            if (document.getElementById("sectionUniteCout" + i.toString()).children[0].children[0].title === "Ouvrière" && document.getElementById("sectionUniteCout" + i.toString()).children[0].children[4].title === "Nourriture" && document.getElementById("sectionUniteCout" + i.toString()).children[0].children[8].title === "Bois" && document.getElementById("sectionUniteCout" + i.toString()).children[0].children[12].title === "Eau") {
            ...
            } else if (document.getElementById("sectionUniteCout" + i.toString()).children[0].children[0].title === "Nourriture" && document.getElementById("sectionUniteCout" + i.toString()).children[0].children[4].title === "Bois" && document.getElementById("sectionUniteCout" + i.toString()).children[0].children[8].title === "Eau") {
                ...
                } else if (parseFloat(needBois) < parseFloat(ressourceBois) && parseFloat(needEau) < parseFloat(ressourceEau)) {
                    if (document.getElementById("myspan" + i.toString()) !== null) {
                        document.getElementById("myspan" + i.toString()).innerText = "⏲️ Tu peux améliorer";
                    } else {
                        span.id = "myspan" + i.toString();
                ...
                if (parseFloat(needPomme) > parseFloat(stockPomme) || parseFloat(needEau) > parseFloat(stockEau)) {
                ...
                } else if (parseFloat(needPomme) < parseFloat(ressourcePomme) && parseFloat(needEau) < parseFloat(ressourceEau)) {
                    if (document.getElementById("myspan" + i.toString()) !== null) {
                        document.getElementById("myspan" + i.toString()).innerText = "⏲️ Tu peux améliorer";
                    } else {
                        span.id = "myspan" + i.toString();
                    ...
                    if (timePomme > timeEau) {
                        ...
                        temps = 0;
                    } else if (timeEau > timePomme) {
                        let temps = timeFormat(timePomme);
                        if (document.getElementById("myspan" + i.toString()) !== null) {
                            document.getElementById("myspan" + i.toString()).innerText = "⏲️ " + temps;
                        } else {
                            span.id = "myspan" + i.toString();
...
export default checkInit(['/recherches'], [], tmpRecherches);